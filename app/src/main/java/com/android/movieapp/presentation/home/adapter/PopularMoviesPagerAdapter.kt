...
class PopularMoviesPagerAdapter(private val listener: OnItemClickListener) : PagingDataAdapter<PopularMovieDomainModel, PopularMoviesPagerAdapter.ViewHolder>(ItemCallback) {
    ...
    private object ItemCallback: DiffUtil.ItemCallback<PopularMovieDomainModel>() {
        override fun areItemsTheSame(oldItem: PopularMovieDomainModel, newItem: PopularMovieDomainModel): Boolean {
            return oldItem.movieId == newItem.movieId
        }

        override fun areContentsTheSame(oldItem: PopularMovieDomainModel, newItem: PopularMovieDomainModel): Boolean {
