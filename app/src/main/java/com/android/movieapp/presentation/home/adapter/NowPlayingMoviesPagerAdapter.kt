...
class NowPlayingMoviesPagerAdapter(private val listener: OnItemClickListener) : PagingDataAdapter<NowPlayingMovieDomainModel, NowPlayingMoviesPagerAdapter.ViewHolder>(ItemCallback) {
    ...
    private object ItemCallback: DiffUtil.ItemCallback<NowPlayingMovieDomainModel>() {
        override fun areItemsTheSame(oldItem: NowPlayingMovieDomainModel, newItem: NowPlayingMovieDomainModel): Boolean {
            return oldItem.movieId == newItem.movieId
        }

        override fun areContentsTheSame(oldItem: NowPlayingMovieDomainModel, newItem: NowPlayingMovieDomainModel): Boolean {
